...
export type GetWatchHistoryAggregateType<T extends WatchHistoryAggregateArgs> = {
    [P in keyof T & keyof AggregateWatchHistory]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateWatchHistory[P]> : Prisma.GetScalarType<T[P], AggregateWatchHistory[P]>;
};
...
export type GetWatchHistoryGroupByPayload<T extends WatchHistoryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<WatchHistoryGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof WatchHistoryGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], WatchHistoryGroupByOutputType[P]> : Prisma.GetScalarType<T[P], WatchHistoryGroupByOutputType[P]>;
}>>;
export type WatchHistoryWhereInput = {
    ...
    stoppedAtSeconds?: Prisma.FloatFilter<"WatchHistory"> | number;
    durationSeconds?: Prisma.FloatFilter<"WatchHistory"> | number;
    isFinished?: Prisma.BoolFilter<"WatchHistory"> | boolean;
...
export type WatchHistoryOrderByWithRelationInput = {
    ...
    stoppedAtSeconds?: Prisma.SortOrder;
...
export type WatchHistoryWhereUniqueInput = Prisma.AtLeast<{
    id?: string;
    userId_tmdbId?: Prisma.WatchHistoryUserIdTmdbIdCompoundUniqueInput;
    AND?: Prisma.WatchHistoryWhereInput | Prisma.WatchHistoryWhereInput[];
    OR?: Prisma.WatchHistoryWhereInput[];
    NOT?: Prisma.WatchHistoryWhereInput | Prisma.WatchHistoryWhereInput[];
    userId?: Prisma.StringFilter<"WatchHistory"> | string;
...
export type WatchHistoryScalarWhereWithAggregatesInput = {
    ...
    stoppedAtSeconds?: Prisma.FloatWithAggregatesFilter<"WatchHistory"> | number;
    durationSeconds?: Prisma.FloatWithAggregatesFilter<"WatchHistory"> | number;
    isFinished?: Prisma.BoolWithAggregatesFilter<"WatchHistory"> | boolean;
...
export type WatchHistoryUpdateInput = {
    ...
    stoppedAtSeconds?: Prisma.FloatFieldUpdateOperationsInput | number;
...
export type WatchHistoryUserIdTmdbIdCompoundUniqueInput = {
    userId: string;
    tmdbId: number;
};
...
export type WatchHistoryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "tmdbId" | "stoppedAtSeconds" | "durationSeconds" | "isFinished" | "updatedAt", ExtArgs["result"]["watchHistory"]>;
...
export type WatchHistoryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<WatchHistoryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface WatchHistoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['WatchHistory'];
        meta: {
            name: 'WatchHistory';
        };
    };
     ...
     * })
    **/
    count<T extends WatchHistoryCountArgs>(args?: Prisma.Subset<T, WatchHistoryCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], WatchHistoryCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends WatchHistoryGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, WatchHistoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWatchHistoryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface WatchHistoryFieldRefs {
    ...
    readonly stoppedAtSeconds: Prisma.FieldRef<"WatchHistory", 'Float'>;
    readonly durationSeconds: Prisma.FieldRef<"WatchHistory", 'Float'>;
    readonly isFinished: Prisma.FieldRef<"WatchHistory", 'Boolean'>;
